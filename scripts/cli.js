...
const contractABI = require("../artifacts/contracts/Badgersettle.sol/Badgersettle.json").abi;

program
    .name("badgersettle-cli")
    .description("CLI tool for Badgersettle smart contract")
    .version("1.0.0");
