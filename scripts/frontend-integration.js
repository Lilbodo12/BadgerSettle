 ...
 * This file demonstrates how to integrate Badgersettle with a web frontend
 */

// For React/Vue/Angular applications
export class BadgersettleClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BadgersettleClient(provider, contractAddress);
